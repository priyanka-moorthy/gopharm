...
$id=$_SESSION['userid'];
$result="SELECT mail,name FROM `users` WHERE name='$id'";
$query= mysql_query($result);
	while($row = mysql_fetch_array($query))
	{
		...
		{
         echo "Message has been sent to " . $row[0] . ".Login to your mail and enter the password given. Click <a href='pg1 loginpage.html'>here</a> to go back to Login page.";
        }
	}
